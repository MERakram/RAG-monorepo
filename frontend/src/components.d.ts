...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    Compare: typeof import('./views/Compare.vue')['default']
    ...
    PdfFileUpload: typeof import('./components/PdfFileUpload.vue')['default']
    RecentChatWrapper: typeof import('./components/RecentChatWrapper.vue')['default']
    RouterLink: typeof import('vue-router')['RouterLink']
    RouterView: typeof import('vue-router')['RouterView']
    SelectCollectionModal: typeof import('./components/SelectCollectionModal.vue')['default']
    SelectModelModal: typeof import('./components/SelectModelModal.vue')['default']
    Signin: typeof import('./views/Signin.vue')['default']
