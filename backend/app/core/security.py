...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="api/v1/authentication/sign-in")
...
def create_access_token(
    data: dict, active: bool, role: str, expires_delta: timedelta | None = None
):
    """
    ...
    to_encode.update({"active": active})
